...
<body>
    ...
    <div class="container text-center mx-auto " style="padding-top:140px;">
        ...
        <form id="loginForm">
            ...
            <div class="form-group text-center mt-5">
                <button type="reset" class="btn btn-outline-light mr-5 btn-lg">清除</button>
                <button onclick="login()" class="btn btn-warning btn-lg" >&nbsp;&nbsp;登入&nbsp;&nbsp;</button>
            </div>
    ...
    <script>
        function login() {
            ...
            $.post("api/check_login.php", form, (chk) => {
                if(parseInt(chk)==0) {
                    alert("帳號或密碼錯誤")
